...
fun CreatorApplyScreen(creatorApplyViewModel: CreatorApplyViewmodel = hiltViewModel()) {
    ...
    val cameraLauncher = rememberLauncherForActivityResult(ActivityResultContracts.TakePicture()) { success ->
        if (success) {
            Tools.takePicturesData(context, contentUri, creatorApplyViewModel.imageBitmapCompanyList, creatorApplyViewModel.imageCompanyUriList)
        }
    }
    ...
    val albumLauncher = rememberLauncherForActivityResult(ActivityResultContracts.PickVisualMedia()) { uri ->
        if (uri != null) {
            Tools.takeAlbumsData(context, uri, creatorApplyViewModel.imageBitmapCompanyList, creatorApplyViewModel.imageCompanyUriList)
        }
    }
            ...
            Column(
                ...
                Text(
                    ...
                    modifier = Modifier
                        ...
                        .clickable {
                            coroutineScope.launch { scaffoldState.bottomSheetState.hide() }
                            creatorApplyViewModel.deleteCompanyImageOnClick() // 모든 이미지 삭제
                        }
                        .padding(vertical = 8.dp)
                )
            }
                ...
                Card(
                    ...
                    Column {
                        ...
                        LikeLionOutlinedTextField(
                            ...
                            textFieldValue = creatorApplyViewModel.creatorShopName,
                        ...
                        creatorApplyViewModel.imageCompanyUriList.forEach { uri ->
                            Text(
                                text = creatorApplyViewModel.getFileNameFromUri(uri), // ✅ Uri를 표시
                                fontSize = 14.sp,
                                color = Color.Gray,
