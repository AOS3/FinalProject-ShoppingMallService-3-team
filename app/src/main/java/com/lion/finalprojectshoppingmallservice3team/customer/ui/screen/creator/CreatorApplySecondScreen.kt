...
fun CreatorApplySecondScreen(creatorApplyViewModel: CreatorApplyViewmodel = hiltViewModel()) {
    ...
    val cameraLauncher = rememberLauncherForActivityResult(ActivityResultContracts.TakePicture()) { success ->
        if (success) {
            Tools.takePicturesData(context, contentUri, creatorApplyViewModel.imageBitmapPortfolioList, creatorApplyViewModel.imagePortfolioUriList)
        }
    }
    ...
    val albumLauncher = rememberLauncherForActivityResult(ActivityResultContracts.PickVisualMedia()) { uri ->
        if (uri != null) {
            Tools.takeAlbumsData(context, uri, creatorApplyViewModel.imageBitmapPortfolioList, creatorApplyViewModel.imagePortfolioUriList)
        }
    }
        ...
        Column(
            ...
            Text(
                ...
                modifier = Modifier
                    ...
                    .clickable {
                        coroutineScope.launch { scaffoldState.bottomSheetState.hide() }
                        creatorApplyViewModel.deletePortfolioImageOnClick() // 모든 이미지 삭제
                    }
                    .padding(vertical = 8.dp)
            )
        }
            ...
            Column(
                ...
                Card(
                    ...
                    Column {
                        ...
                        creatorApplyViewModel.imagePortfolioUriList.forEach { uri ->
                            Text(
