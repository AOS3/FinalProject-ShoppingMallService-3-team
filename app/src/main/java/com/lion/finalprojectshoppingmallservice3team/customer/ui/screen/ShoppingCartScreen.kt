...
import com.lion.finalprojectshoppingmallservice3team.customer.ui.viewmodel.ShoppingCartViewModel
            ...
            CenterAlignedTopAppBar(
                ...
                navigationIcon = {
                    LikeLionIconButton(
                        ...
                        iconButtonOnClick = {
                            shoppingCartViewModel.navigationButtonClick()
                        },
                        borderNull = true,
                    )
                },
        ...
        bottomBar = {
            LikeLionFilledButton(
                ...
                modifier = Modifier
                    ...
                    .padding(8.dp),
                onClick = {
                    shoppingCartViewModel.shopOrderSheetWriteButtonOnClick()
                }
            )
        }
    ) { paddingValues ->
